...
- ["The Blogtrotters" - Westword](https://www.westword.com/news/the-blogtrotters-5091466)
- ["Blog-Searching Umbria Gets Powerful" - Westword](https://www.westword.com/news/blog-searching-umbria-gets-power-ful-5894367)
...
- Co-designed mediator and observer system binding metasystem to UI
- Programmed UI components: node/arc diagrams, notebook, drawing tools
...
- Created generic data binding mechanism
- Re-implemented using RogueWave Tools.h++
